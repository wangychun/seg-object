...
using namespace std;
//////////////////////////////// BBox2DBase ////////////////////////////////
BBox2DBase::BBox2DBase(): bbox_(Rect(0,0,0,0)), className_(""), confidence_(1.0), id_(0){}

BBox2DBase::BBox2DBase(const cv::Rect& rect, const std::string& className, float confidence, int id):
  bbox_(rect), className_(className), confidence_(confidence), id_(id)
{
