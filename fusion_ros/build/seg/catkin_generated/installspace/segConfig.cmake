...
if(seg_CONFIG_INCLUDED)
  return()
endif()
set(seg_CONFIG_INCLUDED TRUE)
...
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'seg' is deprecated")
...
if(NOT "include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/jsoncpp;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(seg_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/jsoncpp;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'sarah <sarah@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${seg_DIR}/../../../include" ABSOLUTE)
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND seg_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(seg_LIBRARY_DIRS ${lib_path})
      list(APPEND seg_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'seg'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND seg_LIBRARIES ${lib})
    endif()
  endif()
...
set(seg_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${seg_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 seg_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${seg_dep}_FOUND)
      find_package(${seg_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${seg_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(seg_INCLUDE_DIRS ${${seg_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(seg_LIBRARIES ${seg_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${seg_dep}_LIBRARIES})
  _list_append_deduplicate(seg_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(seg_LIBRARIES ${seg_LIBRARIES})

  _list_append_unique(seg_LIBRARY_DIRS ${${seg_dep}_LIBRARY_DIRS})
  list(APPEND seg_EXPORTED_TARGETS ${${seg_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${seg_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
